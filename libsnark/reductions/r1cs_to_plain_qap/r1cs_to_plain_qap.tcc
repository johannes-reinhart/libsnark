...
#ifndef R1CS_TO_PLAIN_QAP_TCC_
#define R1CS_TO_PLAIN_QAP_TCC_
 ...
 *
 *  This reduction does not add additional constraints for non-degeneracy
 */
template<typename FieldT>
qap_instance<FieldT> r1cs_to_plain_qap_instance_map(const r1cs_constraint_system<FieldT> &cs)
{
    libff::enter_block("Call to r1cs_to_plain_qap_instance_map");
    ...
    libff::leave_block("Call to r1cs_to_plain_qap_instance_map");
...
qap_instance_evaluation<FieldT> r1cs_to_plain_qap_instance_map_with_evaluation(const r1cs_constraint_system<FieldT> &cs,
                                                                         const FieldT &t)
{
    libff::enter_block("Call to r1cs_to_plain_qap_instance_map_with_evaluation");
    ...
    libff::leave_block("Call to r1cs_to_plain_qap_instance_map_with_evaluation");
...
qap_witness<FieldT> r1cs_to_plain_qap_witness_map(const r1cs_constraint_system<FieldT> &cs,
                                            ...
                                            const FieldT &d3)
{
    libff::enter_block("Call to r1cs_to_plain_qap_witness_map");
...
#pragma omp parallel for
    ...
    libff::leave_block("Call to r1cs_to_plain_qap_witness_map");
